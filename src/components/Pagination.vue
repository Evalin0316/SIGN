...
<div class="flex justify-center item-center">
    <!-- <div class="mr-2 text-[#be8e55] cursor-pointer" v-if="selectPage > 1"  @click="changePage(selectPage-1)">前一頁</div> -->
    ...
    <!-- <div class="ml-2 text-[#be8e55] cursor-pointer" v-if="selectPage < pages" @click="changePage(selectPage+1)">下一頁</div> -->
</div>
</template>
